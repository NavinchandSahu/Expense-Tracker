...
from expensetracker_database import fetch_expenses,add_expenses_to_db,delete_expenses_from_db
class ExpenseApp(QWidget):
    ...
    def add_expense(self):
        ...
        if add_expenses_to_db(date,category,amount,description):
            self.load_table_data()
            self.clear_inputs()
        else:
    ...
    def delete_expense(self):
        ...
        if confirm == QMessageBox.StandardButton.Yes and delete_expenses_from_db(expense_id):
            self.load_table_data()
